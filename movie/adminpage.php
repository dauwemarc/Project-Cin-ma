...
<body style="background: #efc0c0" >
	...
	<div class="header">
		...
		<div class="container" >
			...
			<div class="row">
				<div class="col-md-4">
					<a style="width: 100%; text-align: center;" href="AddMovie.php" class="myButton">Ajouter un film</a>
				</div>
				<div  class="col-md-4">
					<a style="width: 100%; text-align: center; margin-top: .5vw;" href="addtheater.php" class="myButton">Ajouter un cinéma </a>
				</div>
				<div  class="col-md-4">
