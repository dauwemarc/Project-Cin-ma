...
<body>
	...
	$showOrder="";//
	$seatCount="";//conter de place


//Check si la date existe;
...
//1er input dans la bdd
	if (!$dateExists) {
		...
		if ($conn->query($sql) === TRUE) {
			...
			$showOrder=$r->showOrderId;//on vas l'utiliser pour reduire les places
						...
						<div class=" col-md-8 col-lg-8 ">
							<table class="table table-user-information">
								<tbody>
									...
									<tr>
										<td><strong>Nom du film </strong></td>
									...
									<tr>
										<td><strong>Nom du ciné </strong></td>
									...
									<tr>
										<td><strong>Prix ticket </strong></td>
										<td> 300 </td>
									</tr>
