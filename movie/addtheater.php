	...
	<div class="bg" >
		...
		<div class="container">
			<form id="contact" action="addtheater.php" method="post" enctype="multipart/form-data">
				...
				<input  name="TheaterName" placeholder="nom du cinéma" type="text" tabindex="1" required autofocus>
				<input style="font-size: larger;background-color: #c2fbb8;font-family: cursive;font-weight: bold;"
				class="boxStyle" type="submit" name="submit" value="Ajouter un cinéma">
				<p class="copyright"></p>
